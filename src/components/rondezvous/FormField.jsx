    ...
    <div>
      ...
      <div>
        <input
          ...
          name={name}
          className={`font-medium w-full mt-1 p-2 pl-3 rounded-full border ${redBorder} text-[#02295a] text-[15px] hover:border-[#02295a] focus:border-white focus:ring-[#bfe2fd]`}
          type="text"
